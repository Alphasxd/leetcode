...
// 方法二：使用小顶堆，堆中存储的是元素值，堆中元素的个数为 k
// 当堆中元素的个数小于 k 时，直接将元素添加到堆中，等于 k 时，将元素与堆顶元素进行比较，
// 如果元素的频率大于堆顶元素的频率，则将堆顶元素删除，将元素添加到堆中，否则直接忽略该元素
// 最后将堆中的 k 个元素添加到 ans 中，返回 ans 即可
